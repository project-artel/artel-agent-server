...
SYSTEM_PROMPT = (
    ...
    "\n"
    "Neither is a target the scene gives no id for. When the scene reports screen "
    "coordinates for what you are aiming at, you can act on the pixels directly: "
    "`move_pointer` to hover, `drag_pointer` to drag one point onto another. "
    "Coordinates are screen pixels with the origin at the BOTTOM-LEFT, so y grows "
    "upwards; convert if the scene measures from the top.\n"
    "\n"
